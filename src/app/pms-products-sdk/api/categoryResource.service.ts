...
import { CategoryFDTO } from '../model/categoryFDTO';
...
export class CategoryResourceService {
     ...
     */
    public createCategoryUsingPOST(categoryDTO: CategoryDTO, observe?: 'body', reportProgress?: boolean): Observable<CategoryDTO>;
    public createCategoryUsingPOST(categoryDTO: CategoryDTO, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<CategoryDTO>>;
    public createCategoryUsingPOST(categoryDTO: CategoryDTO, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<CategoryDTO>>;
    public createCategoryUsingPOST(categoryDTO: CategoryDTO, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getCategoryFullInfoUsingGET(id: number, observe?: 'body', reportProgress?: boolean): Observable<CategoryFDTO>;
    public getCategoryFullInfoUsingGET(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<CategoryFDTO>>;
    public getCategoryFullInfoUsingGET(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<CategoryFDTO>>;
    public getCategoryFullInfoUsingGET(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getCategoryFullInfoUsingGET.');
        }
        ...
        return this.httpClient.get<CategoryFDTO>(`${this.basePath}/api/categories/${encodeURIComponent(String(id))}/full-info`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getCategoryUsingGET(id: number, observe?: 'body', reportProgress?: boolean): Observable<CategoryDTO>;
    public getCategoryUsingGET(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<CategoryDTO>>;
    public getCategoryUsingGET(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<CategoryDTO>>;
